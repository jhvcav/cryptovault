...
const NFT_CONFIG = {
  bronze: {
    ...
    multiplier: 1.2,
    plans: [
      { id: 'starter', name: 'Starter', apr: 15, duration: 30 }
    ]
  },
  silver: {
    name: 'NFT Argent',
    ...
    plans: [
      { id: 'starter', name: 'Starter', apr: 15, duration: 30 },
      { id: 'standard', name: 'Standard', apr: 20, duration: 90 }
    ]
  },
  gold: {
    name: 'NFT Or',
    ...
    plans: [
      { id: 'starter', name: 'Starter', apr: 15, duration: 30 },
      { id: 'standard', name: 'Standard', apr: 20, duration: 90 },
      { id: 'premium', name: 'Premium', apr: 25, duration: 180 }
    ]
  },
  privilege: {
    name: 'NFT Privilège',
    ...
    plans: [
      ...
      { id: 'standard', name: 'Standard', apr: 20, duration: 90 },
      { id: 'premium', name: 'Premium', apr: 25, duration: 180 },
      { id: 'enterprise', name: 'Enterprise', apr: 30, duration: 360 }
