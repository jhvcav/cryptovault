...
const CommunityRegistrationPage: React.FC = () => {
  ...
  const registerCommunityAcceptance = async () => {
    try {
      ...
      setSuccess('Inscription réussie ! Votre NFT d\'accès communauté va être généré. Vous recevrez bientôt les informations pour rejoindre nos formations.');
      setCurrentStep(4);
    ...
    >
                  ...
                  <VStack spacing={6}>
                    ...
                    <Box w="full">
                      ...
                      <VStack spacing={4} align="start">
                        ...
                        >
                          <Text fontSize="sm">
                            ...
                            <Link color="purple.600" onClick={onCharterOpen} textDecoration="underline">
                              Charte de la Communauté CryptocaVault
                            </Link>
                          </Text>
                        </Checkbox>
                        ...
                        <Box bg="yellow.50" p={4} borderRadius="xl" w="full">
                          <Checkbox
                    ...
                    <Button
                      ...
                      leftIcon={<Text fontSize="xl">🌟</Text>}
                    >
                      Rejoindre la Communauté CryptocaVault
                    </Button>
                  </VStack>
                </Box>
              )}
                ...
                <Box textAlign="center">
                  <Box bg="green.50" borderRadius="xl" p={8}>
                    ...
                    <Heading size="xl" color="green.800" mb={4}>
                      Bienvenue dans la Communauté CryptocaVault !
                    </Heading>
                    <VStack spacing={3} color="green.700">
                      ...
                      <HStack>
                        <Text fontSize="xl">✅</Text>
                        <Text>Votre NFT d'accès communauté est en cours de génération</Text>
                      </HStack>
                      <HStack>
                        <Text fontSize="xl">✅</Text>
                    ...
                    <Box mt={6} bg="blue.50" borderRadius="lg" p={4}>
                      ...
                      <VStack spacing={2} fontSize="sm" color="blue.700">
                        ...
                        <Text>2. Rejoindre les groupes WhatsApp/Telegram/Discord</Text>
                        <Text>3. Participer à la prochaine formation (21h30 GMT+3)</Text>
                        <Text>4. Une fois formé, demander l'accès à la plateforme de trading</Text>
                      </VStack>
                    </Box>
                  </Box>
                </Box>
      ...
      <Modal isOpen={isCharterOpen} onClose={onCharterClose} size="xl">
        ...
        <ModalContent maxH="80vh">
          <ModalHeader>Charte de la Communauté CryptocaVault</ModalHeader>
          <ModalCloseButton />
            ...
            <VStack spacing={4} align="start">
              ...
              <Box>
                ...
                <VStack spacing={1} align="start" fontSize="sm" color="gray.600">
                  ...
                  <Text>• Utilisation sécurisée de la plateforme CryptocaVault</Text>
                </VStack>
              </Box>
