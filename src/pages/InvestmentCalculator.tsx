...
const INVESTMENT_PLANS = [
  { id: 'starter', name: 'Plan Starter', apr: 15, duration: 30 },
  { id: 'standard', name: 'Plan Standard', apr: 20, duration: 90 },
  { id: 'premium', name: 'Plan Premium', apr: 25, duration: 180 },
  { id: 'enterprise', name: 'Plan Enterprise', apr: 30, duration: 360}
];
