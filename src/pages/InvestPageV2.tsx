//src/pages/InvestPageV2.tsx
import React, { useState } from 'react';
import { Link } from 'react-router-dom';
import { useInvestmentV2 } from '../contexts/InvestmentContextV2'; // Votre contexte fonctionnel
import { useNFTAccess } from '../hooks/useNFTAccess'; // Hook NFT 
import { useWallet } from '../contexts/WalletContext';
import InvestmentModalV2 from '../components/invest/InvestmentModalV2'; // Votre modal fonctionnel
import { 
  TrendingUp, 
  Clock, 
  DollarSign, 
...
const InvestPage: React.FC = () => {
  ...
  const { plans, invest, loading: investmentLoading } = useInvestmentV2();
    ...
    <div className="min-h-screen px-4 py-8">
            ...
            <div className="inline-flex items-center space-x-3 bg-gradient-to-r from-blue-900/30 to-purple-900/30 border border-blue-500/30 rounded-xl px-8 py-4">
              <div className="flex items-center space-x-2">
                ...
                <h2 className="text-2xl font-bold text-white">
                  Plans de récompenses accessibles Version V2
                </h2>
              </div>
      ...
      {selectedPlan && (
        <InvestmentModalV2
          ...
          effectiveAPR={selectedPlan.apr * multiplier}
        />
      )}
    </div>
  );
